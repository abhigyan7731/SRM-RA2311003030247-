...
function getToken(){
  try{const t = localStorage.getItem('evaluationAuthToken'); if(t) return t;}catch(e){}
...
export default async function Log(stack,level,packageName,message){
  ...
  try{const res = await fetch(ENDPOINT,{method:'POST',headers,body:JSON.stringify(body)}); return res.ok;}catch(e){return false;}
}
